...
public final class ItemTree {
    ...
    /** 1.12: "tags" are ore dictionary names ("ingotIron"); a namespace prefix is ignored. */
    ...
    private static final class Node {
        ...
        private static boolean matchesClass(ItemStack stack, String clazz) {
            ...
            switch (clazz) {
                ...
                case "helmet":
                    return isArmorFor(item, EntityEquipmentSlot.HEAD);
                case "chestplate":
                    return isArmorFor(item, EntityEquipmentSlot.CHEST);
                case "leggings":
                    return isArmorFor(item, EntityEquipmentSlot.LEGS);
                case "boots":
                    return isArmorFor(item, EntityEquipmentSlot.FEET);
                case "armor":
                ...
                default:
                    // crossbow/trident etc. don't exist in 1.12
                    return false;
            }
        }

        private static boolean isArmorFor(Item item, EntityEquipmentSlot slot) {
