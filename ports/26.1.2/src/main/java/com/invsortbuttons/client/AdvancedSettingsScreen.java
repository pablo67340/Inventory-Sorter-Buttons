...
public class AdvancedSettingsScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.centeredText(this.font, Component.translatable("invsortbuttons.settings.pvpnote1"),
                this.width / 2, this.height / 6 + 16, 0xE0E0E0);
        graphics.centeredText(this.font, Component.translatable("invsortbuttons.settings.pvpnote2"),
