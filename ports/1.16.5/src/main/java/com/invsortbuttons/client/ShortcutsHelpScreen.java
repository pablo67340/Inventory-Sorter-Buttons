...
public class ShortcutsHelpScreen extends Screen {
    ...
    public ShortcutsHelpScreen(Screen parent) {
        super(new TranslationTextComponent("invsortbuttons.help.title"));
        this.parent = parent;
    }
    ...
    public void render(MatrixStack pose, int mouseX, int mouseY, float partialTick) {
        ...
        for (String key : LINES) {
            drawCenteredString(pose, this.font, new TranslationTextComponent(key), this.width / 2, y, 0xE0E0E0);
            y += 14;
        }
