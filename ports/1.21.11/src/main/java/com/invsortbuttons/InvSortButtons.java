 ...
 * buttons and settings screen for Forge 1.20.6, working on any mod's containers.
 */
...
public class InvSortButtons {
    ...
    public InvSortButtons(net.minecraftforge.fml.javafmlmod.FMLJavaModLoadingContext context) {
        context.registerConfig(ModConfig.Type.CLIENT, ISBConfig.SPEC);
        NetworkHandler.init();
    }
}
