...
public class AdvancedSettingsScreen extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("invsortbuttons.settings.pvpnote1"),
                this.width / 2, this.height / 6 + 16, 0xE0E0E0);
        this.drawCenteredString(this.fontRendererObj, I18n.format("invsortbuttons.settings.pvpnote2"),
