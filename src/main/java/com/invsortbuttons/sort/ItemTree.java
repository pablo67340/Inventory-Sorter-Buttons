...
public final class ItemTree {
    ...
    public boolean matches(ItemStack stack, String keyword) {
        if (keyword.startsWith("#")) {
            ...
            return rl != null && stack.is(TagKey.create(Registry.ITEM_REGISTRY, rl));
        }
        if (keyword.contains(":")) {
    ...
    private static final class Node {
        ...
        boolean matchesItem(ItemStack stack) {
            ...
            if (this.tag != null) {
                ...
                if (rl != null && stack.is(TagKey.create(Registry.ITEM_REGISTRY, rl))) {
                    return true;
                }
            }
            if (this.clazz != null) {
        ...
        private static boolean matchesClass(ItemStack stack, String clazz) {
            ...
            return switch (clazz) {
                ...
                case "helmet" -> item instanceof ArmorItem a && a.getSlot() == EquipmentSlot.HEAD;
                case "chestplate" -> item instanceof ArmorItem a && a.getSlot() == EquipmentSlot.CHEST;
                case "leggings" -> item instanceof ArmorItem a && a.getSlot() == EquipmentSlot.LEGS;
                case "boots" -> item instanceof ArmorItem a && a.getSlot() == EquipmentSlot.FEET;
